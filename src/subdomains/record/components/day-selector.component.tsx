...
import { formatDayName, formatDayNumber, isSameDay } from '@/src/shared/modules/helpers/date.helper'
import { useDaySelector } from '../hooks/use-day-selector'

export const DaySelector = () => {
  const { selectedDay, displayedDays, handleDayClick, startDate, endDate } = useDaySelector()

  return (
    <div className="overflow-x-auto remove-scrollbar col-span-2">
            ...
            <React.Fragment key={index}>
              <button
                ...
                className={cn(
                  ...
                  'hover:bg-accent/5',
                  isSelected && 'bg-gradient-to-br from-primary via-primary to-brand-blue-dark text-primary-foreground hover:opacity-90',
